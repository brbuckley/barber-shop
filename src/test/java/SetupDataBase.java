...
public class SetupDataBase {
    ...
    public static void setup() throws NotExistException {
        ...
        HaircutRepo haircutRepo = new HaircutRepo("TestPersistence");
        AppointmentRepo appointmentRepo = new AppointmentRepo("TestPersistence");
        QueueRepo queueRepo = new QueueRepo("TestPersistence");
        ReservationRepo reservationRepo = new ReservationRepo("TestPersistence");
        ...
        appointmentRepo.add(appointment3);
