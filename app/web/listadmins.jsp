...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Área Admin > Admin</h6>
                        </div>
                        <div class="card-body">
                                            ...
                                            <tr> 
                                                ...
                                                <td> 
                                                    <div class="text-center">
                                                        <a href="#" onclick="carregarDadosEdicao('adminModalLabel', 'edit', 'Administrador', ['idAdmin', 'name', 'email'], [ '<c:out value='${admin.id}'/>', '<c:out value='${admin.name}'/>', '<c:out value='${admin.email}'/>'])" data-toggle="modal" data-target="#adminModal">
                                                                <i class="fas fa-1x fa-edit pr-1"></i>                       
                                                        </a>
                                                        <a href="#" data-toggle="modal" onclick="carregarDadosEdicao('adminLabel', 'delete', 'Administrador', ['id_exclusao'], [ '<c:out value='${admin.id}'/>'])"   data-target="#exclusaoModal">
    ...
    aria-hidden="true">
       <div class="modal-dialog" role="document">
           <div class="modal-content">
               <div class="modal-header">
                   <h5 class="modal-title" id="clienteModalLabel">Edição de Administradores</h5>
                   <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                       <span aria-hidden="true">×</span>
                   </button>
               </div>
               <!-- Corpo do modal -->
               <form method="post" action="${pageContext.request.contextPath}/AdminController?action=salvar">
                    <div class="modal-body">                    
                        <div class="row g-3">
                            <div class="col-md-12">
                              <input  name="idAdmin" class="form-control" type="hidden" value="<c:out value="${admin.id}"/>" id="idAdmin"> 
                              <label for="validacaoNome" class="form-label">Nome</label>
                              <input  required="required" name="name" type="text" class="form-control" value="<c:out value="${admin.name}" />" id="name" required> 
                               <label for="validacaoEmail" class="form-label">E-mail</label>
                              <input  required="required" name="email" type="text" class="form-control" value="<c:out value="${admin.email}" />" id="email" required>    
                            </div>
                        </div>                    
                    </div>
              ...
              <div class="modal-body">                    
                  <form class="row g-3 needs-validation" novalidate>
                      ...
                      <div class="col-md-5">
                        ...
                        <label class="text-primary" class="form-label">${admin.emai}</label>
                      </div>                     
                  </form>             
              </div>
              <div class="modal-footer">
